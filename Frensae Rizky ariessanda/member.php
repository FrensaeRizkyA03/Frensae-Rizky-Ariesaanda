        ...
        <div style="width:50%;background:white;height:400px;postion:relative;background:white;margin:auto;box-shadow:0 0 1px 1px rgba(0, 0, 0, 0.16);">
          <button type="button" class="closetab" name="button"><i class="fa fa-close"></i></button>
              <form class="centerY form" id="iniForm" action="index.html" method="post">
                ...
                <button type="submit" class="sobmit" name="button">Tambah</button>
              </form>
        </div>
    </div>
</div>
  ...
  <div class="vendor row">
      ...
      <div style="width:calc(100% - 250px);float:left;">
        <div style="padding:5px 25px;">
          <div class="row">
            <div style="width:31.3%;color:white;height:120px;background:pink(255, 78, 78);position:relative;margin:20px 1%;margin-left:0%;margin-right:2%;float:left;box-sizing:border-box;">
              
            <div style="width:31.3%;position:relative;color:white;height:120px;background:pink(78, 133, 255);margin:20px 1%;float:left;box-sizing:border-box;">

            <div style="position:relative;width:31.3%;height:120px;color:white;background:pink(157, 255, 94);margin:20px 1%;margin-left:2%;margin-right:0%;float:left;box-sizing:border-box;">
          ...
          <p style="font-size:8pt;opacity:0.3;margin:10px 0;">&copy; Frensae Rizky Ariessanda- <?php echo Date('Y') ?> All Rights Reserved</p>
        </div>
      </div>
